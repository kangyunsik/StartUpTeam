...
public class Meta implements Parcelable {
    ...
    public static final Creator<Meta> CREATOR = new Creator<Meta>() {
        @Override
        public com.example.startupteam.Meta createFromParcel(Parcel source) {
            return new com.example.startupteam.Meta(source);
        }

        @Override
        public com.example.startupteam.Meta[] newArray(int size) {
            return new com.example.startupteam.Meta[size];
        }
    };
}