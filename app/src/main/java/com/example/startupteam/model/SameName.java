...
public class SameName implements Parcelable {
    ...
    public static final Creator<SameName> CREATOR = new Creator<SameName>() {
        @Override
        public com.example.startupteam.SameName createFromParcel(Parcel source) {
            return new com.example.startupteam.SameName(source);
        }

        @Override
        public com.example.startupteam.SameName[] newArray(int size) {
            return new com.example.startupteam.SameName[size];
        }
    };
}
