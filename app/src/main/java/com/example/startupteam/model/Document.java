...
public class Document implements Parcelable {
    ...
    public static final Creator<com.example.startupteam.Document> CREATOR = new Creator<com.example.startupteam.Document>() {
        @Override
        public com.example.startupteam.Document createFromParcel(Parcel source) {
            return new com.example.startupteam.Document(source);
        }

        @Override
        public com.example.startupteam.Document[] newArray(int size) {
            return new com.example.startupteam.Document[size];
        }
    };
}